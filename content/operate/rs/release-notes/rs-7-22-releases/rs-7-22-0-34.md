---
Title: Redis Enterprise Software release notes 7.22.0-34 (April 2025)
alwaysopen: false
categories:
- docs
- operate
...
description: Bug fixes for performance issues related to search indexes with HNSW vector fields, a CRDB syncer issue, and increased job_scheduler memory usage when the diagnostic logging service is enabled.
linkTitle: 7.22.0-34 (April 2025)
weight: 89
---

This is a maintenance release for ​[​Redis Enterprise Software version 7.22.0](https://redis.io/downloads/#software).
...
- Bug fixes for performance issues related to search indexes with HNSW vector fields, a CRDB syncer issue, and increased job_scheduler memory usage when the diagnostic logging service is enabled
...
- RS156570: Fixed an issue where Redis Enterprise Software version 7.22.0 could experience a significant performance impact with elevated CPU usage and slow database operations, when using search indexes with vector fields of type HNSW.

- RS155261: Fixed an issue where the CRDB syncer could fail after an upgrade due to `SASL negotation failed` errors.

- RS156391: Fixed an issue where the `job_scheduler`'s memory usage could increase significantly when the diagnostic logging service is enabled.
...
| Package | SHA256 checksum (7.22.0-34 April release) |
|---------|---------------------------------------|
...
Redis Enterprise Software 7.22.0-34 supports open source Redis 7.4, 7.2, and 6.2. Below is the list of open source Redis CVEs fixed by version.
